...
export default function Page() {
  return (
    <main className="relative flex h-svh flex-col items-center justify-between px-6 py-6 md:py-8 lg:py-5 xl:py-6">
      ...
      {/* Hero */}
      <section className="flex w-full flex-1 flex-col items-center justify-center gap-5 py-4 md:gap-6 lg:gap-5 lg:py-2 xl:gap-7 xl:py-3">
        <div className="flex w-full justify-center">
          <div className="w-full max-w-[min(70vw,40vh)] md:max-w-[min(60vw,42vh)] lg:max-w-[min(50vw,42vh)] xl:max-w-[min(42vw,44vh)] aspect-square">
            <video
        ...
        <div className="flex flex-col items-center gap-4 text-center md:gap-5 xl:gap-6">
          <h1 className="font-display leading-[1.05] tracking-[-0.02em] text-[clamp(2rem,5vw,5rem)]">
            Your cheatcode to
            <br />
            Internet Capital Markets.
          </h1>
          <p className="font-medium uppercase tracking-[0.18em] text-[var(--color-muted)] text-[clamp(0.7rem,1vw,1rem)]">
